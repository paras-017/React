  ...
  return (
    ...
    <div className=" text-center w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-500">
      ...
      <div className="flex shadow overflow-hidden mb-4">
        <input type="text" value={Password} className='outline-none w-full py-1 px-3 my-3' placeholder='password' readOnly/>
        <button className='outline-none bg-blue-700 text-white px-3 shrink-0'>copy</button>
      </div>
      <div className="flex text-sm gap-x-2">
        <div className='flex items-center gap-x-1'>
          <input type="range" min={6} max={100} value={length} className='cursor-pointer' onChange={e=>{setLength(e.target.length)}}/>
